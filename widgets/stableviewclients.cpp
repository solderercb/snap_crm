...
STableViewClients::STableViewClients(QWidget *parent) : STableViewBase(parent)
{
    ...
    readLayout(SLocalSettings::CustomersGrid);
...
{
    saveLayout(SLocalSettings::CustomersGrid);
}
