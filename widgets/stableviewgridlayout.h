...
class t_Columns : public QSerializer {
    ...
    QS_XML_MARKED_FIELD(int, Width)    // В АСЦ это поле может содержать символ *, означающий, что ширина столбца изменяется автоматически под ширину окна (увеличивается, если есть место после крайнего правого столбца или уменьшается, если ширина всех столбцов больше ширины виджета
